...
export class DocumentoService {
     ...
     * @param produto
     */
    salvar(documento): Promise<any> {
        return this.wso2Client.post(`/api/v1/documento`, documento)
            .then((retorno: any) => {
     ...
     * @param produto
     */
    editar(documento): Promise<any> {
        return this.wso2Client.put(`/api/v1/documento/` + documento.id, documento)
            .then((retorno: any) => {
                return retorno.conteudo;
            });
    }
    ...
    consultar(filtro): Promise<any> {
        ...
        return this.wso2Client.get(`/api/v1/documento/`, data)
            .then((retorno: any) => {
                return retorno;
            });
    }
    ...
    consultarById(id: number): Promise<any> {
        return this.wso2Client.get(`/api/v1/documento/` + id)
            .then((retorno: any) => {
                return retorno.conteudo;
            });
    }
    ...
    deletar(id: number): Promise<any> {
        return this.wso2Client.delete(`/api/v1/documento/` + id)
            .then((retorno: any) => {
                return retorno.conteudo;
            });
    }
    ...
    idioma(): Promise<any> {
        return this.wso2Client.get(`/api/v1/documento/idioma`)
            .then((retorno: any) => {
                return retorno;
            });
    }
