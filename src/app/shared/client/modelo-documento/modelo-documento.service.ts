...
export class ModeloDocumentoService {
     ...
     * @param produto
     */
    salvar(modeloDocumento): Promise<any> {
        return this.wso2Client.post(`/api/v1/modelo-documento`, modeloDocumento)
            .then((retorno: any) => {
     ...
     * @param produto
     */
    editar(modeloDocumento): Promise<any> {
        return this.wso2Client.put(`/api/v1/modelo-documento/` + modeloDocumento.id, modeloDocumento)
            .then((retorno: any) => {
                return retorno.conteudo;
            });
    }
    ...
    consultar(filtro): Promise<any> {
        ...
        return this.wso2Client.get(`/api/v1/modelo-documento/`, data)
            .then((retorno: any) => {
                return retorno;
            });
    }
    ...
    consultarById(id: number): Promise<any> {
        return this.wso2Client.get(`/api/v1/modelo-documento/` + id)
            .then((retorno: any) => {
                return retorno.conteudo;
            });
    }
    ...
    deletar(id: number): Promise<any> {
        return this.wso2Client.delete(`/api/v1/modelo-documento/` + id)
            .then((retorno: any) => {
                return retorno.conteudo;
            });
    }
