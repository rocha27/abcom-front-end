...
export class GrupoProdutoService {
     ...
     * @param produto
     */
    salvar(grupoProduto): Promise<any> {
        return this.wso2Client.post(`/api/v1/grupoProduto`, grupoProduto)
            .then((retorno: any) => {
     ...
     * @param produto
     */
    editar(grupoProduto): Promise<any> {
        return this.wso2Client.put(`/api/v1/grupoProduto`, grupoProduto)
            .then((retorno: any) => {
                return retorno.conteudo;
            });
    }
    ...
    consultar(filtro): Promise<any> {
        ...
        return this.wso2Client.get(`/api/v1/grupoProduto/`, data)
            .then((retorno: any) => {
                return retorno.conteudo;
            });
    }
    ...
    consultarById(id: number): Promise<any> {
        return this.wso2Client.get(`/api/v1/grupoProduto/` + id)
            .then((retorno: any) => {
                return retorno.conteudo;
            });
    }
    ...
    deletar(id: number): Promise<any> {
        return this.wso2Client.delete(`/api/v1/grupoProduto/` + id)
            .then((retorno: any) => {
                return retorno.conteudo;
            });
    }
